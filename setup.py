...
MODULE_SLUG = "simulacao"

setup(
    name=MODULE_SLUG,
    version="0.1.0",
    author="carloshernani-CH",
    author_email="carloshcdpg@al.insper.edu.br",
    description="APS4",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/carloshernani-CH/simulacao",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'simulacao-cli={MODULE_SLUG}.main:app',
        ],
    },
